...
import static com.alibaba.datax.common.base.Constant.DEFAULT_FETCH_SIZE;
import static com.alibaba.datax.common.base.Key.FETCH_SIZE;
import static com.alibaba.datax.common.base.Key.HAVE_KERBEROS;
import static com.alibaba.datax.common.base.Key.KERBEROS_KEYTAB_FILE_PATH;
import static com.alibaba.datax.common.base.Key.KERBEROS_PRINCIPAL;
...
//            this.originalConfig.set(Key.FETCH_SIZE, Integer.MIN_VALUE);
            ...
            this.originalConfig = commonRdbmsReaderJob.init2(originalConfig);
        }
